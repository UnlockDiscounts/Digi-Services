...
const AboutUs = () => {
  ...
  const services = [
    {
      title: "GST Filing",
      description: "Accurate and timely GST return filing services...",
      image: imgImage51,
      color: "#6364ff",
    },
    {
      title: "Social Media Marketing",
      description: "Expert income tax return preparation...",
      image: imgImage52,
      color: "#6364ff",
    },
    {
      title: "Website Development",
      description: "Strategic SMM services to enhance presence...",
      image: imgImage53,
      color: "#6364ff",
    },
    {
      title: "ITR Filing",
      description: "Custom, responsive websites designed to convert...",
      image: imgImage54,
      color: "#6364ff",
    },
    {
      title: "Resume Building",
      description: "Professionally crafted resumes that highlight...",
      image: imgImage51,
      color: "#6364ff",
    },
  ];
    ...
    <div className="bg-white relative min-h-screen overflow-x-hidden">
      ...
      <AnimatedSection className="bg-[rgba(172,173,188,0.2)] flex flex-col gap-[32px] items-center px-6 md:px-[64px] py-[32px] w-full">
        ...
        <div className="font-['Poppins'] text-[23px] text-black w-full max-w-[1312px] mx-auto">
          <p className="mb-4 text-center md:text-left">
            At Unlock Digi Services, we are a passionate team of professionals
            dedicated to simplifying digital and financial services for
            individuals, freelancers, and small businesses across India.
          </p>
          <p className="mb-4 text-center md:text-left">
            Founded with the belief that quality services should be accessible
            and affordable to everyone, we bridge the gap between complex
            government processes and modern digital needs. Our team includes
            certified tax consultants, creative digital marketers, skilled
            developers, and expert resume writers.
          </p>
          <p>
            Whether you're a startup looking to build a professional brand, a
            job seeker preparing to impress recruiters, or a business owner
            managing taxes, we're here to make it easy, efficient, and
            stress-free.
          </p>
        </div>
      </AnimatedSection>
      ...
      <div className="w-full py-12 px-4">
        <div className="relative mx-auto overflow-hidden bg-transparent flex-shrink-0 w-full max-w-[1130px] aspect-[1130/981]">
          ...
          <div className="absolute left-0 top-0 w-[53.8%] h-[41%]">
            <div
              className="w-full h-full overflow-hidden isolation-isolate"
            ...
            >
              <motion.div
                ...
                transition={
                  currentIndex === 0 ? { duration: 0 } : transitionProps
                }
                ...
                {[...topLeftImages, topLeftImages[0]].map((imgSrc, i) => (
                  <div key={i} className="flex-shrink-0 w-full h-full p-4">
                    <img
                      src={imgSrc}
                      alt=""
                      className="w-full h-full object-cover shadow-lg hover:scale-[1.02] transition-all"
                    />
                  </div>
                ))}
              </motion.div>
          ...
          <div className="absolute right-0 bottom-0 w-[46.2%] h-[40%]">
            ...
            >
              ...
              >
                {[...bottomRightImages, bottomRightImages[0]].map(
                  (imgSrc, i) => (
                    <div key={i} className="flex-shrink-0 w-full h-full p-4">
                      <img
                        src={imgSrc}
          ...
          {/* Center divider */}
          <div
            className="absolute h-full bg-white z-10 opacity-100"
            style={{
              left: "53.8%",
              width: "32px",
          ...
          <div
            className="absolute w-[53.8%] bg-white z-10 opacity-100"
            style={{
              top: "41%",
              height: "16px",
              left: 0,
          ...
          {/* Horizontal Gap Reinforcement */}
          <div
            className="absolute w-[46.2%] bg-white z-10 opacity-100"
            style={{
              top: "60%",
              right: 0,
              height: "32px",
      ...
      <AnimatedSection className="flex flex-col gap-[48px] items-center px-6 md:px-[64px] py-[32px] w-full max-w-[1440px] mx-auto mt-12">
        ...
        <div className="text-[24px] text-black w-full text-center md:text-left">
          <p className="mb-4">
            At Unlock Digi Services, our vision is to be India's most trusted
            and accessible partner for digital and compliance services...
          </p>
          <p className="mb-4">
            Our mission is to simplify complex processes like and business
            compliance by offering expert-led solutions...
          </p>
          <p>
            Driven by a client-first approach, we prioritize accuracy,
            reliability, and fast delivery in everything we do.
          </p>
        </div>
        ...
        >
          {[
            ...
            },
            {
              ...
              description:
                "Your success is our priority. We listen to your needs and understand your goals.",
            },
            {
              icon: svgPaths.p3268a800,
              title: "Innovation",
              description:
                "We embrace cutting-edge technologies and creative approaches to keep you ahead.",
            },
          ].map((value, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <div className="relative z-10 flex flex-col gap-[4px] items-center justify-center w-full">
                ...
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: hoveredValueCard === idx ? 1 : 0 }}
                  className="font-['Poppins'] text-[18px] text-white text-center mt-4 px-4"
                >
                  {value.description}
                </motion.p>
              </div>
      ...
      <AnimatedSection className="bg-[rgba(172,173,188,0.2)] flex flex-col gap-[32px] items-center px-6 md:px-[64px] py-[60px] w-full mt-12">
        <div className="flex flex-col gap-[16px] items-center text-center w-full">
          <h2 className="font-medium text-[48px] text-black">
            Why Clients Choose Us
          </h2>
          <p className="text-[24px] text-black max-w-[900px]">
            We combine expertise with personalized service to deliver
            exceptional results.
          </p>
        </div>
          ...
          {[
            {
              ...
              description: "Our team consists of certified tax experts...",
            },
            {
              icon: svgPaths.p148ba500,
              title: "Cost Efficient",
              description:
                "We provide affordable services without compromising quality...",
            },
            {
              icon: svgPaths.pf2e1f80,
              title: "Timely Delivery",
              description: "We understand the importance of deadlines...",
            },
            {
              icon: svgPaths.p30089180,
              title: "Data Security",
              description:
                "Your data is safe with us. We follow strict protocols...",
            },
            {
            ...
            },
            {
              ...
              description: "Every client is unique. We tailor our services...",
            },
          ].map((feature, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full px-8">
                ...
                >
                  ...
                  >
                    <rect
                      fill={hoveredCard === idx ? "white" : "#6364FF"}
                      height="79"
                      rx="39.5"
                      width="79"
                    />
                    <path
                      d={feature.icon}
                      fill={hoveredCard === idx ? "#6364FF" : "white"}
                    />
                  </svg>
                </motion.div>
                <motion.p
                  animate={{
                    color: hoveredCard === idx ? "#ffffff" : "#000000",
                    y: hoveredCard === idx ? -20 : 0,
                  }}
                ...
                <motion.p
                  ...
                  className="text-[18px] text-white text-center leading-relaxed mt-2"
                >
                  {feature.description}
                </motion.p>
              </div>
          ...
          <div className="relative h-[749px] md:h-[749px] h-[500px] w-[1440px] md:w-[1440px] w-full flex-shrink-0 px-4 md:px-0">
            <div className="absolute left-0 md:left-[670px] top-[139px] md:top-[139px] top-[20px] w-full md:w-[1100px] h-[471px] md:h-[471px] h-[400px] overflow-hidden px-2 md:px-0">
              ...
              >
                {services.map((service, idx) => (
                  <div
                    key={idx}
                    className="bg-white h-[471px] rounded-[6px] w-[331px] flex-shrink-0 relative overflow-hidden shadow-lg"
                  >
                    <h3
                      className="font-bold text-[26px] text-center mt-[18px] px-4"
            ...
            <div className="hidden md:block absolute left-[137px] top-0 h-[749px] w-[500px] rounded-[16px] overflow-hidden">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(145deg, rgba(254, 203, 242, 0.9), rgba(3, 52, 255, 0.9))",
                }}
              />
      ...
      <AnimatedSection className="flex flex-col gap-8 px-4 sm:px-6 md:px-8 lg:px-[64px] py-8 w-full lg:w-[1440px] mx-auto my-12 sm:my-16">
        ...
        >
          <h2 className="font-medium text-[28px] sm:text-[32px] md:text-[48px] text-black leading-tight">
            Our Commitment
          </h2>
        </motion.div>
        <motion.p
        ...
        >
          At Unlock Digi Services, we are committed to providing accurate,
          transparent, and affordable solutions that help our clients succeed.
          We deliver every service with professionalism, confidentiality, and
          care.
        </motion.p>
      </AnimatedSection>
    </div>

...
export function HeroSection() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-16 overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <motion.h1
            ...
            className="font-['Poppins'] font-medium text-white text-4xl sm:text-5xl lg:text-[72px] leading-[1.3]"
          >

  ...
  return (
    <>
      ...
      <div className="absolute right-0 top-[60px] bg-white rounded-[8px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] w-[300px] h-[262px] z-50">
        <p className="font-['Poppins',sans-serif] font-medium leading-[normal] p-[10px] text-[18px] text-black">Sort By</p>
        
        <div className="bg-[#d5d5d5] flex h-[37px] items-center p-[10px]">
          <p className="font-['Poppins',sans-serif] font-medium leading-[normal] text-[18px] text-black">Sort by Date</p>
        </div>
        ...
        <div className="relative h-[60px]">
          ...
          >
            ...
            <p className="font-['Poppins',sans-serif] text-[18px] text-black">Newest First</p>
            {sortBy === 'newest' && (
          ...
          >
            ...
            <p className="font-['Poppins',sans-serif] text-[18px] text-black">Oldest First</p>
            {sortBy === 'oldest' && (
              <div className="ml-auto mr-4">
                {/* <svg className="size-[14px]" fill="none" viewBox="0 0 14.5 10.3313">
                  <path d={svgPaths.p2186700} stroke="#907AFF" strokeLinecap="round" strokeWidth="2" />
        ...
        <div className="bg-[#d5d5d5] flex h-[37px] items-center p-[10px] mt-2">
          <p className="font-['Poppins',sans-serif] font-medium leading-[normal] text-[18px] text-black">Sort Alphabetically</p>
        </div>
        ...
        <div className="relative h-[70px]">
          ...
          >
            ...
            <p className="font-['Poppins',sans-serif] text-[18px] text-black">A-Z (Title)</p>
            {sortBy === 'a-z' && (
              <div className="ml-auto mr-4">
                {/* <svg className="size-[14px]" fill="none" viewBox="0 0 14.5 10.3313">
                  <path d={svgPaths.p2186700} stroke="#907AFF" strokeLinecap="round" strokeWidth="2" />
          ...
          >
            ...
            <p className="font-['Poppins',sans-serif] text-[18px] text-black">Z-A (Title)</p>
            {sortBy === 'z-a' && (
              <div className="ml-auto mr-4">
                {/* <svg className="size-[14px]" fill="none" viewBox="0 0 14.5 10.3313">
                  <path d={svgPaths.p2186700} stroke="#907AFF" strokeLinecap="round" strokeWidth="2" />
